...
[entity]: apple
[entity types]: ['/person/musician', '/person/artist', '/person', '/organization', '/organization/company']
[Fine-Grained Entity Classification Result]:  '/organization', '/organization/company' 
...
if __name__ == '__main__':
    ...
    metric = Scores()
    logger.add('./logs2/test1_type_' + str(args.kind) + f"_{args.limit}_" + \
    ...
    for li, true_labels in data.get_data:
        ...
        try:
            ...
            metric.update([data.mp[_] for _ in true_labels], [data.mp[_] for _ in pred_labels])
